...
///////////////////////////////////////////////////////// do not overload a virtual func
// helper FileSystemSearch scope, static, nonstatic, glob(outside the class), or local, member function
// AST analysis complexity, linenumber, many pointers mean class not safe
...
std::string Path::getBef(const std::string& fileSpec)
{
	size_t pos1 = fileSpec.find_last_of('/');
	size_t pos2 = fileSpec.find_last_of('\\');
	size_t pos = fileSpec.find_last_of('.');
